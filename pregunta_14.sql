...
--  
--SELECT K0, avg(tbl2.c21) FROM tbl1 JOIN tbl2 WHERE c13>400 GROUP BY 1
SELECT tbl1.K0, avg(c21) FROM tbl1 JOIN tbl2 ON tbl1.K1=tbl2.K1 WHERE tbl1.c13>400 GROUP BY 1
